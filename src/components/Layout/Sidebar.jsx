...
import { Menu, BarChart3, Users, UserCheck, Zap, Map, Edit3, User, ChevronLeft } from 'lucide-react';
import { useState } from 'react';

const menuItems = [
  { icon: BarChart3, label: 'Dashboard', path: '/dashboard' },
  { icon: Users, label: 'Workers', path: '/workers' },
  { icon: UserCheck, label: 'Supervisors', path: '/supervisors' },
  { icon: Zap, label: 'Issues', path: '/issues' },
  { icon: Map, label: 'Map View', path: '/map' },
  { icon: Edit3, label: 'Ward Editor', path: '/geojson-editor' },
