        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              <p className="text-sm font-semibold text-avenue-on-surface">{user.fullName}</p>
              <p className="text-xs text-avenue-on-surface-variant">Administrator</p>
            </div>
