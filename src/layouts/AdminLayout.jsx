...
export default function AdminLayout() {
  ...
  const getNavLinkClass = ({ isActive }) =>
    isActive
      ? "flex items-center gap-3 px-6 py-3 bg-[#1E40AF] text-white rounded-r-full mr-4 transition-all"
      : "flex items-center gap-3 px-6 py-3 text-slate-300 hover:bg-white/10 transition-all mr-4";
