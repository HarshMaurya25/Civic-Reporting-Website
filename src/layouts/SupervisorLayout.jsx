...
export default function SupervisorLayout() {
  ...
  const getNavLinkClass = ({ isActive }) =>
    isActive
      ? "flex items-center gap-4 px-6 py-3 bg-[#1E40AF] text-white rounded-r-full mr-4 font-['Inter'] text-sm font-medium transition-all"
      : "flex items-center gap-4 px-6 py-3 text-slate-300 hover:bg-white/10 font-['Inter'] text-sm font-medium transition-all";
